        ...
        <header class="logo-env">
          ...
          <div class="logo">
            ...
            <a href="#"
              ...
              <img src="../assets/images/logo-collapsed@2x.png"
                   width="40"
                   alt="" />
            </a>
          </div>
        ...
        <ul id="main-menu"
          ...
          <li v-for="(menu, idx) in items"
            ...
            <ul v-if="menu.children">
              <li v-for="(submenu, idx) in menu.children"
                  :key="idx">
                <a :href="'#'+transName(submenu)"
                   class="smooth"
                   @click="moveSlow">
    ...
    <div class="main-content">
      <nav class="navbar user-info-navbar"
        ...
        <ul class="user-info-menu left-links list-inline list-unstyled">
          ...
          <li class="dropdown hover-line language-switcher">
            ...
            <ul class="dropdown-menu languages">
              <li :class="{active: langItem.key === lang.key}"
        ...
        <ul class="user-info-menu right-links list-inline list-unstyled">
          <li class="hidden-sm hidden-xs">
            <a href="https://github.com/zhangsison"
               target="_blank">
